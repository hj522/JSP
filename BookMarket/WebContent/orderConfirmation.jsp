		...
		<table class="table table-hover">
			...
			<%	//스크립틀릿
				...
				for(int i=0;i<cartList.size();i++){
					Book bk = cartList.get(i);	// 상품 목록에서 상품을 하나 끄집어내자
					double total = bk.getUnitPrice() * bk.getQuantity();	// 얼마짜리 몇 개 샀니?
			...
			%>
			<tr>
				<td class="text-center"><em><%=bk.getName()%></em></td>
				<td class="text-center"><%=bk.getQuantity()%></td>
				<td class="text-center"><fmt:formatNumber value="<%=bk.getUnitPrice()%>" pattern="#,###" />원</td>
