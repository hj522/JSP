...
<%
	...
	while(params.hasNext()) {
		...
		// Spring프레임워크에서는 MultipartFile로 쉽게 처리 가능!
		if(item.isFormField()){		// 6-1) 일반 데이터
			...
			} else if(item.getFieldName().equals("menufacturer")){
				menufacturer = item.getString("UTF-8");
	...
	productVO.setManufacturer(menufacturer);
