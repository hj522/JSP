...
public class ProductRepository {
	...
	// 싱글톤 패턴: 객체가 메모리에 1번 올라감! 공유해서 사용
	...
	public ProductRepository() {
		// 1) SmartPhone 상품 추가(1행(ProductVO) 추가)
	...
	public ProductVO getProductById(String productId) {
		...
		*/
		...
		for(int i=0;i<listOfProducts.size();i++) {
			...
			if(vo!=null && vo.getProductId()!=null && vo.getProductId().contentEquals(productId)) {
				productById = vo;
				// 반복문을 빠져나옴
				break;
			}
